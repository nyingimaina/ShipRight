...
{
    // Shared watch-branch routes used by both desktop and cloud. Cloud mode maps the
    // history route separately against the MariaDB-backed store (see CloudWatchBranchRouter).
    public static void MapWatchBranchCoreRoutes(this WebApplication app)
    {
    ...
    public static void MapWatchBranchRoutes(this WebApplication app)
    {
        ...
        app.MapGet("/api/watch-branch/history", (
            SqliteWatchBranchHistoryStore store,
